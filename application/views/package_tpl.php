...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Queen Villa & Spa &middot; Packages</title>
	...
	/* wndj Custom CSS */
	h2 { color :#feca28; }
	.muted { color:#feca28;text-transform:italic; }
	.top40 { padding-top:410px;diplay:block;}
	.featurette-heading { color:#fff;}
    </style>
  ...
  <body style="background-color:#000;color:#fff;font-family:georgia,serif;">
    ...
    <div class="container marketing">
      ...
      <div class="row">
        <div class="span4">
          <img src="/assets/img/c_1.jpg" class="img-circle" data-src="holder.js/140x140">
		  <h2>Queen Holiday</h2>
          <p>Donec sed odio dui. Etiam porta sem malesuada magna mollis euismod. Nullam id dolor id nibh ultricies vehicula ut id elit. Morbi leo risus, porta ac consectetur ac, vestibulum at eros. Praesent commodo cursus magna, vel scelerisque nisl consectetur et.</p>
          <p><a class="btn" href="#">View details &raquo;</a></p>
        </div><!-- /.span4 -->
        <div class="span4">
          <img src="/assets/img/c_2.jpg" class="img-circle" data-src="holder.js/140x140">
          <h2>Queen Diving</h2>
          <p>Duis mollis, est non commodo luctus, nisi erat porttitor ligula, eget lacinia odio sem nec elit. Cras mattis consectetur purus sit amet fermentum. Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet risus.</p>
          <p><a class="btn" href="#">View details &raquo;</a></p>
        </div><!-- /.span4 -->
        <div class="span4">
          <img src="/assets/img/c_3.jpg" class="img-circle" data-src="holder.js/140x140">
          <h2>Queen Honeymoon</h2>
          <p>Donec sed odio dui. Cras justo odio, dapibus ac facilisis in, egestas eget quam. Vestibulum id ligula porta felis euismod semper. Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet risus.</p>
          <p><a class="btn" href="#">View details &raquo;</a></p>
        </div><!-- /.span4 -->
		
		<div class="span4">
          <img src="/assets/img/c_4.jpg" class="img-circle" data-src="holder.js/140x140">
          <h2>Queen Gili's</h2>
          <p>Donec sed odio dui. Cras justo odio, dapibus ac facilisis in, egestas eget quam. Vestibulum id ligula porta felis euismod semper. Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet risus.</p>
          <p><a class="btn" href="#">View details &raquo;</a></p>
        </div><!-- /.span4 -->
		<div class="span4"></div>
		<div class="span4">
          <img src="/assets/img/c_5.jpg" class="img-circle" data-src="holder.js/140x140">
          <h2>Queen Meeting</h2>
          <p>Donec sed odio dui. Cras justo odio, dapibus ac facilisis in, egestas eget quam. Vestibulum id ligula porta felis euismod semper. Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet risus.</p>
          <p><a class="btn" href="#">View details &raquo;</a></p>
        </div><!-- /.span4 -->
